...
final class BedrockViews implements PlatformViews {
    ...
    BedrockViews(Translator registrationTranslator, Translator authenticationTranslator) {
    ...
    public View<AuthenticationAction> authentication(Player player, AuthenticationViewState state) {
        ...
        view.text(this.authTranslate_(
                ...
                state.isPlatformFirstTime() ? "disclosure.platform_first_time"
                                            : "disclosure.regular",
                state.isPlatformFirstTime() ? "Type your password to verify yourself."
        ...
        return view
            ...
            .input(
                    PASSWORD,
                    this.authTranslate_(player, "input.password", "Password:"),
                    this.authTranslate_(player, "input.password_placeholder", "Your password"),
                    "",
                    true,
                    256
            )
    ...
    public View<RegistrationAction> registration(Player player, RegistrationViewState state) {
        ...
        view.text(this.regTranslate_(player, "disclosure", "Define a password to protect your account from Java Edition."));
        ...
        return view
            ...
            .input(
                    PASSWORD,
                    this.regTranslate_(player, "input.password", "Password:"),
                    this.regTranslate_(player, "input.password_placeholder", "creeper123"),
                    "",
                    true,
                    256
            )
            ...
            .input(
                    CONFIRM_PASSWORD,
                    this.regTranslate_(player, "input.confirm_password", "Confirm password:"),
                    this.regTranslate_(player, "input.confirm_password_placeholder", "creeper123"),
                    "",
                    true,
                    256
            )
